...
;(function($) {
    ...
    $.fn.bjqs = function(o) {
        ...
        var defaults        = {
			...
			rotate			: false, // Automatic slide change rotation. If false, slice change will stop after a cycle.
        ...
        var init = function() {
            ...
            if(settings.automatic){
                state.interval = setInterval(function () {
					var scount = parseInt(state.slidecount),
						current = parseInt(state.currentindex);
					if((scount == current+1 ||  (scount == current+2 && settings.animtype == 'slide')) && !settings.rotate) {
						settings.automatic = false;
